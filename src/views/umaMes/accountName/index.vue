  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <div style="display: inline-block;margin: 0px 2px;">
        <el-button
          v-permission="['admin','accountName:add']"
          class="filter-item"
          size="mini"
          type="primary"
          icon="el-icon-plus"
    ...
    <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
      ...
      <el-table-column v-if="checkPermission(['admin','accountName:edit','accountName:del'])" label="操作" width="150px" align="center">
        <template slot-scope="scope">
          ...
          <el-popover
            v-permission="['admin','accountName:del']"
            :ref="scope.row.id"
            placement="top"
            width="180">
            <p>确定删除本条数据吗？</p>
...
import { del, downloadAccountName } from '@/api/accountName'
...
export default {
  ...
  methods: {
    ...
    download() {
      ...
      downloadAccountName(this.params).then(result => {
        downloadFile(result, 'AccountName列表', 'xlsx')

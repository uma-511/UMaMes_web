    ...
    <el-dialog
      ...
      <el-row>
        <el-table
          ...
          <el-table-column prop="prodNumber" label="数量" width="120px" align="center">
          </el-table-column>
          <el-table-column prop="lnventoryNumber" label="盘点数量" width="120px" align="center">
            <template slot-scope="scope">
              <el-input v-model="scope.row.lnventoryNumber" :disabled="lnventoryStatus == 2?true:false" :min="0" type="number" @input = "sum(scope.row)"/>
            </template>
          </el-table-column>
          <el-table-column prop="lnventorySurplus" label="盘盈数量" width="120px" align="center"/>
          <el-table-column prop="lnventoryLoss" label="盘亏数量" width="120px" align="center"/>
        </el-table>
